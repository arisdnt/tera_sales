        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30">
            <div className="w-full max-w-sm bg-white shadow-2xl border border-slate-200">
                ...
                <div className="border-t border-slate-200 px-4 py-3 bg-slate-50 flex justify-end gap-2">
                    <button
                        onClick={onCancel}
                        className="px-4 py-1.5 text-sm border border-slate-300 text-slate-700 font-semibold hover:bg-slate-100 transition-colors"
                        disabled={deleting}
                    >
                        Batal
                    </button>
                    <button
                        ...
                        disabled={deleting}
                        className="flex items-center gap-1.5 px-4 py-1.5 text-sm bg-red-600 text-white font-semibold hover:bg-red-700 transition-colors disabled:opacity-50"
                    >
                        <Trash2 size={14} />
